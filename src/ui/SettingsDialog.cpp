...
SettingsDialog::SettingsDialog(const QString &lang, const AppSettings &settings, QWidget *parent) : QDialog(parent) {
    ...
    const QString fireTunnelDetails = ru
            ? "Клиент: FireTunnel<br/>Разработчик: pnsrc<br/>GitHub: <a href=\"https://github.com/pnsrc/TrustTunnelClient\">https://github.com/pnsrc/TrustTunnelClient</a>"
            : "Client: FireTunnel<br/>Developer: pnsrc<br/>GitHub: <a href=\"https://github.com/pnsrc/TrustTunnelClient\">https://github.com/pnsrc/TrustTunnelClient</a>";
