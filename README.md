...
Графический клиент для TrustTunnel на Qt. Данный репозиторий является саб модулем, для основного репозитория, где осуществляется сборка и основная доработка https://github.com/pnsrc/TrustTunnelClient. Скачать актуальную версию клиента, вы можете там.
